...
<body width="100%" bgcolor="2f4550" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: #57707d; padding-top:2.3em; padding-bottom:2.3em; text-align: left;">
        <!--
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px 40px 20px; text-align: center;">
                                    <h1 style="margin: 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal;">View Message</h1>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align: center;">
                                        <form>
                                                <br>
                                                <textarea class="fromUser" name="toUser" placeholder="Message From"></textarea>
                                                <br>
                                                <textarea class="messagearea" name="UserComments" placeholder="the Message"></textarea>
                                              </form>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tr>
                                            <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                                <a href="http://www.google.com" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 110%; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                                    <span style="color:#ffffff;" class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;Reply???? Redirect to sendMessage&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
